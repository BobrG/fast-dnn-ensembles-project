...
class CurveNet(Module):
    def __init__(self, model_name, num_classes, curve, architecture, num_bends, fix_start=True, fix_end=True,
                 architecture_kwargs={}):
        ...
        if model_name == 'AE':
            self.net = self.architecture(3, 64, 64, bottleneck=128, fix_points=self.fix_points)
        else:
